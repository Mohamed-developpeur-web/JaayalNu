...
<body>
    ...
    <dl>
        <dt>Utilisateur</dt>
        <dd>{{ $visiteur->user ? $visiteur->user->name : 'N/A' }}</dd>
    </dl>

    <p>
        <a class="button" href="{{ route('visiteurs.index') }}">Retour à la liste</a>
        <a class="button" href="{{ route('visiteurs.edit', $visiteur) }}">Modifier</a>
    </p>
</body>
</html>
